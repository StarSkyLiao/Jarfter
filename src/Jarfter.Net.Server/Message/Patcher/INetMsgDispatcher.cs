...
public interface INetMsgDispatcher
{
    ...
    /// <param name="handler">处理程序.</param>
    /// <returns>可用于撤销注册的处理程序句柄.</returns>
    NetMsgPatcherHandle On<TMessage>(INetMsgEnvelopeHandler<TMessage> handler) where TMessage : INetMessage<TMessage>;
    ...
    /// <param name="handler">处理程序.</param>
    /// <returns>可用于撤销注册的处理程序句柄.</returns>
    NetMsgPatcherHandle On<TMessage>(INetMsgEnvelopeRepliedHandler<TMessage> handler) where TMessage : INetMessage<TMessage>;
