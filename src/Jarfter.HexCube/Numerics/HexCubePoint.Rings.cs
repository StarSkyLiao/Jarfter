...
public readonly partial record struct HexCubePoint
{
    ...
    /// 注意: 半径为 0 时并不会返回自身.
    /// </summary>
    public struct RingCollection(HexCubePoint point, int radius) : IEnumerator<HexCubePoint>, IReadOnlyCollection<HexCubePoint>
    {
        ...
        public HexCubePoint Current
        {
            get
            {
                ...
                HexCubePoint corner = s_Directions[(side + 4) % 6];
