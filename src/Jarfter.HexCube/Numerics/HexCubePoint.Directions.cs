...
public readonly partial record struct HexCubePoint
{
    ...
    private static readonly HexCubePoint[] s_Directions =
    [
        new HexCubePoint(1, 0),
        new HexCubePoint(1, -1),
        new HexCubePoint(0, -1),
        new HexCubePoint(-1, 0),
        new HexCubePoint(-1, 1),
        new HexCubePoint(0, 1)
    ];
    ...
    public HexCubePoint NeighborAt(Direction direction)
    {
    ...
    /// </summary>
    /// <param name="direction">给定的六边形网格方向.</param>
    public HexCubePoint NeighborAtUnchecked(int direction) => this + s_Directions[direction];

    /// <summary>
    /// 六边形网格点所有邻居的集合.
    /// </summary>
    public struct NeighborCollection(HexCubePoint point) : IEnumerator<HexCubePoint>, IReadOnlyCollection<HexCubePoint>
    {
        ...
        /// <inheritdoc />
        public HexCubePoint Current => point + s_Directions[m_Index];
        ...
        /// <inheritdoc />
        IEnumerator<HexCubePoint> IEnumerable<HexCubePoint>.GetEnumerator() => GetEnumerator();
