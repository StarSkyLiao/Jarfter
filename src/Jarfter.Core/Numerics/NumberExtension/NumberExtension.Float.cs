...
public static partial class NumberExtension
{
    extension(float value)
    {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int Sign() => value < 0f ? -1 : value > 0f ? 1 : 0;
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Min(float min) => value < min ? min : value;
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Max(float max) => value > max ? max : value;
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Clamp01() => value < 0f ? 0f : value > 1f ? 1f : value;
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float CircleClamp(float leftInclude, float rightExclude)
        {
            ArgumentOutOfRangeException.ThrowIfLessThanOrEqual(rightExclude, leftInclude);

            float range = rightExclude - leftInclude;
            float offset = value - leftInclude;
            if (range > 0f && offset >= 0f && offset < range) return value;
            offset %= range;
