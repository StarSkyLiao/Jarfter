...
public static partial class NumberExtension
{
    extension(decimal value)
    {
        ...
        public decimal Abs() => decimal.Abs(value);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int Sign() => decimal.Sign(value);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal Pow(int power)
        {
            decimal result = 1m;
            decimal baseValue = value;
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal Min(decimal min) => decimal.Max(value, min);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal Max(decimal max) => decimal.Min(value, max);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal Clamp01() => Math.Clamp(value, 0m, 1m);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal Clamp(decimal min, decimal max) => Math.Clamp(value, min, max);
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public decimal CircleClamp(decimal leftInclude, decimal rightExclude)
        {
            ArgumentOutOfRangeException.ThrowIfLessThanOrEqual(rightExclude, leftInclude);

            decimal range = rightExclude - leftInclude;
            decimal offset = value - leftInclude;
            if (range > 0m && offset >= 0m && offset < range) return value;
            offset %= range;
            if (offset < 0m) offset += range;
