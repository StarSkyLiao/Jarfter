...
/// </summary>
public static class HexWeightedAStarRunTest
{
    private static readonly IPathfinder s_Pathfinder = new IPathfinder.AStar(
        IHeuristic.Default.Instance, HexPathfindingConfig.NavigationProvider, 2
    );
    ...
    public static void RunResult()
    {
        ...
        string filePath = Path.Combine("HexAStarWeightedPath.bmp");
